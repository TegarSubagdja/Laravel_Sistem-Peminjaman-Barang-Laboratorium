        ...
        <div class="col-lg">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="demo-inline-spacing">
                        <span class="badge bg-label-danger">Primary</span>
                ...
                <div class="card-body">
                    ...
                    <div class="demo-inline-spacing">
                        <span class="badge rounded-pill bg-label-danger">Primary</span>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="demo-inline-spacing">
                                <button type="button" class="btn btn-danger">
                                    Text
                                    <span class="badge bg-white text-danger ms-1">4</span>
                                </button>
                                <button type="button" class="btn btn-danger">
                                    Text
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="demo-inline-spacing">
                                <p>
                                    <span class="badge badge-center rounded-pill bg-label-danger">1</span>
                                ...
                                <p>
                                    <span class="badge badge-center bg-label-danger">1</span>
