        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn rounded-pill btn-danger">Primary</button>
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <small class="text-light fw-medium">Rounded</small>
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn rounded-pill btn-outline-danger">Primary</button>
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-xl btn-danger">Button xl</button>
                        <button type="button" class="btn btn-lg btn-danger">Button lg</button>
                        <button type="button" class="btn btn-danger">Button</button>
                        <button type="button" class="btn btn-sm btn-danger">Button sm</button>
                        <button type="button" class="btn btn-xs btn-danger">Button xs</button>
                    </div>
                </div>
                <hr class="m-0" />
                <div class="card-body">
                    ...
                    <div class="row gy-3">
                        <div class="col-xl-3">
                            ...
                            <div class="demo-vertical-spacing">
                                <button type="button" class="btn btn-danger d-block" data-bs-toggle="button">Toggle
                                    button</button>
                                <button type="button" class="btn btn-danger active d-block" data-bs-toggle="button"
                                    aria-pressed="true">Active toggle button</button>
                                <button type="button" class="btn btn-danger d-block" disabled
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="demo-vertical-spacing">
                                <div class="d-block">
                                    ...
                                    <label class="btn btn-danger" for="btn-check">Single toggle</label>
                                </div>
                                <div class="d-block">
                                    <input type="checkbox" class="btn-check" id="btn-check-2" checked>
                                    <label class="btn btn-danger" for="btn-check-2">Checked</label>
                                </div>
                                <div class="d-block">
                                    <input type="checkbox" class="btn-check" id="btn-check-3" checked>
                                    <label class="btn btn-danger" for="btn-check-3">Checked</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            ...
                            <div class="demo-vertical-spacing">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                    ...
                                    <label class="btn btn-outline-danger d-flex flex-column" for="btncheck1"><span
                                            class="d-none d-sm-block">Checkbox</span>1 ( pre-checked )</label>

                                    <input type="checkbox" class="btn-check" id="btncheck2">
                                    <label class="btn btn-outline-danger d-flex flex-column" for="btncheck2"><span
                                            class="d-none d-sm-block">Checkbox</span>2</label>

                                    <input type="checkbox" class="btn-check" id="btncheck3">
                                    <label class="btn btn-outline-danger d-flex flex-column" for="btncheck3"><span
