                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-2">
                                            <div class="col mb-0">
                                                ...
                                                <input type="email" id="emailSlideTop" class="form-control"
                                                    placeholder="xxxx@xxx.xx">
                                            </div>
                                            <div class="col mb-0">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="mt-3">
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#youTubeModal" data-theVideo="https://www.youtube.com/embed/EngW7tLk6R8">
                            Launch modal
                        </button>
                        ...
                        <div class="modal fade" id="modalToggle" aria-labelledby="modalToggleLabel" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-danger" data-bs-target="#modalToggle2"
                        ...
                        <div class="modal fade" id="modalToggle2" aria-hidden="true" aria-labelledby="modalToggleLabel2"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-danger" data-bs-target="#modalToggle"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row g-2">
                                        <div class="col mb-0">
                                            ...
                                            <input type="email" id="emailLarge" class="form-control"
                                                placeholder="xxxx@xxx.xx">
                                        </div>
                                        <div class="col mb-0">
