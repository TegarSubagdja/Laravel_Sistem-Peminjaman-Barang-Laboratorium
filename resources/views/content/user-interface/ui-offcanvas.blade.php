        ...
        <div class="card-body">
            <div class="row gy-3">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasStart" aria-controls="offcanvasStart">Toggle Start</button>
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart"
                            ...
                            <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                                <p class="text-center">Lorem ipsum, or lipsum as it is sometimes known, is dummy text used
                                    in laying out print, graphic or web designs. The passage is attributed to an unknown
                                    typesetter in the 15th century who is thought to have scrambled parts of Cicero's De
                                    Finibus Bonorum et Malorum for use in a type specimen book.</p>
                                <button type="button" class="btn btn-danger mb-2 d-grid w-100">Continue</button>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasEnd" aria-controls="offcanvasEnd">Toggle End</button>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Toggle Top</button>
                        <div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop"
                            ...
                            <div class="offcanvas-body">
                                ...
                                <button type="button" class="btn btn-danger me-2">Continue</button>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">Toggle Bottom</button>
        ...
        <div class="card-body">
            <div class="row gy-3">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasScroll" aria-controls="offcanvasScroll">Enable Body
                            Scrolling</button>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasBackdrop" aria-controls="offcanvasBackdrop">Enable backdrop</button>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-danger" type="button" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasBoth" aria-controls="offcanvasBoth">Enable both scrolling &
                            backdrop</button>
