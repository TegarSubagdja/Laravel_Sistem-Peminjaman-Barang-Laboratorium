            ...
            <div class="row gx-3 gy-2 align-items-center">
                <div class="col-md-3">
                    ...
                    <select id="selectTypeOpt" class="form-select color-dropdown">
                        <option value="bg-danger" selected>Primary</option>
                ...
                <div class="col-md-3">
                    ...
                    <button id="showToastPlacement" class="btn btn-danger d-block">Show Toast</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-0">
            <div class="col-md-6 p-4">
                ...
                <div class="toast-container position-relative">
                    ...
                    <div class="bs-toast toast fade show bg-secondary" role="alert" aria-live="assertive"
                        aria-atomic="true">
                        <div class="toast-header">
                            <i class='bx bx-bell me-2'></i>
                            <div class="me-auto fw-medium">Bootstrap</div>
                    ...
                    <div class="bs-toast toast fade show bg-dark" role="alert" aria-live="assertive"
                        aria-atomic="true">
                        <div class="toast-header">
                            <i class='bx bx-bell me-2'></i>
                            <div class="me-auto fw-medium">Bootstrap</div>
