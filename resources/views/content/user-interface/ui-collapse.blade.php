            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="demo-inline-spacing">
                        <a class="btn btn-danger me-1" data-bs-toggle="collapse" href="#collapseExample" role="button"
                            aria-expanded="false" aria-controls="collapseExample">
                            Link with href
                        </a>
                        <button class="btn btn-danger me-1" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="d-grid d-sm-flex p-3 border">
                            <img src="{{ asset('assets/img/elements/1.jpg') }}" alt="collapse-image" height="125"
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="demo-inline-spacing">
                        <a class="btn btn-danger me-1" data-bs-toggle="collapse" href="#multiCollapseExample1"
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-2 mb-md-0">
                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                <div class="d-grid d-sm-flex p-3 border">
                                    <img src="{{ asset('assets/img/elements/2.jpg') }}" alt="collapse-image" height="125"
                                        class="me-4 mb-sm-0 mb-2">
                                    <span>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="collapse multi-collapse" id="multiCollapseExample2">
                                <div class="d-grid d-sm-flex p-3 border">
                                    <img src="{{ asset('assets/img/elements/3.jpg') }}" alt="collapse-image" height="125"
                                        class="me-4 mb-sm-0 mb-2">
                                    <span>
