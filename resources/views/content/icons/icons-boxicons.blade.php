...
@section('content')
    ...
    <div class="d-flex justify-content-center mx-auto gap-3">
        <a href="https://boxicons.com/" target="_blank" class="btn btn-danger">View All Icons</a>
        <a href="{{ config('variables.documentation') }}/Icons.html" class="btn btn-danger" target="_blank">How to use
            icons?</a>
    </div>
@endsection
