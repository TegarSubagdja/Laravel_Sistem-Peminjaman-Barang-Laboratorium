        ...
        <div class="card-datatable table-responsive">
            <div class="dataTables_wrapper dt-bootstrap5 no-footer" id="DataTables_Table_0_wrapper">
                <div class="card-header flex-column flex-md-row pb-0">
                    ...
                    <div class="dt-action-buttons text-end p-sm-4">
                        <div class="dt-buttons flex-wrap" id="export">
                            ...
                            <button class="btn btn-danger create-new" tabindex="0" aria-controls="DataTables_Table_0"
                                ...
                                <span>
                                    <i class="bx bx-plus bx-sm me-sm-2">
                                    </i>
                            ...
                            <div class="offcanvas offcanvas-end" id="add-new-record">
                                ...
                                <div class="offcanvas-body flex-grow-1">
                                    <form class="add-new-record pt-0 row g-2 fv-plugins-bootstrap5 fv-plugins-framework"
                                        ...
                                        <div class="col-sm-12 fv-plugins-icon-container">
                                            ...
                                            <div class="input-group input-group-merge has-validation">
                                                ...
                                                <input type="text" class="form-control dt-date flatpickr-input"
                                                    id="basicDate" name="basicDate" aria-describedby="basicDate2"
                                        ...
                                        <div class="col-sm-12">
                                            <button type="submit"
                                                class="btn btn-danger data-submit me-sm-3 me-1">Submit</button>
